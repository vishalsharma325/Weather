...
Open `index.html` in your web browser to see the dashboard in action!
...
2. Find line 6: `this.apiKey = 'YOUR_API_KEY_HERE';`
...
2. **Option 2: Local Server (Recommended)**
   - For better performance and to avoid CORS issues, serve the files through a local server:
